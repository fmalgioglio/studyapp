...
const COPY = {
  en: {
    title: "Subjects",
    subtitle: "Keep subjects tidy so objectives and materials stay easy to manage.",
    addTitle: "Add subject",
    name: "Subject name",
    color: "Color",
    add: "Add subject",
    noSubjects: "No subjects yet.",
    linkedExams: "Linked objectives",
    studyDirection: "Connected study rhythm",
    openExams: "Open objectives",
    delete: "Delete",
    ...
    noDirection: "No linked objective yet for this subject.",
    ...
    whyBody: "Use each subject as the home for related objectives, materials, and study fit.",
    statsSubjects: "Subjects",
    statsTargets: "Objectives",
    statsNext: "Ready next",
    statsNextEmpty: "Create one",
    statsNextReady: "Link objectives",
    noAccountBody: "Sign in again to manage subjects and keep them linked to the right objectives.",
    login: "Go to login",
    createAccount: "Create account",
    emptyBody: "Create the first subject now so objectives and materials have a clear home.",
  },
  it: {
    title: "Materie",
