export const BRANDING = {
  ...
  gradients: {
    appBackground:
      "bg-[radial-gradient(circle_at_top_left,#dbeafe_0%,transparent_45%),radial-gradient(circle_at_bottom_right,#cffafe_0%,transparent_35%),linear-gradient(180deg,#f8fafc_0%,#eef2ff_100%)]",
  },
} as const;
